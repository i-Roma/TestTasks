...
public extension UIView {
    ...
    func addBorder(width: CGFloat? = nil, color: UIColor? = nil, masksToBounds: Bool = false) {
        
        let borderWidth = width != nil ? width! : (1 as CGFloat)
        let borderColor = color != nil ? color! : .lightGray
    ...
    func addInnerBorder(width: CGFloat? = nil, color: UIColor? = nil, masksToBounds: Bool = false) {
        
        let borderWidth = width != nil ? width! : (1 as CGFloat)
        let borderColor = color != nil ? color! : .lightGray
        
        frame = frame.insetBy(dx: 0, dy: -borderWidth)
        layer.borderWidth = borderWidth
        layer.borderColor = borderColor.cgColor
        layer.masksToBounds = masksToBounds
    }
